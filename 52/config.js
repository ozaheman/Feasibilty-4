...
export const LEVEL_ORDER = [
    ...
    'Podium', 'Podium_Last', 'Office', 'Commercial', 'Typical_Floor', 'Hotel', 'LabourCamp', 'Warehouse', 'Roof'
];
export const LEVEL_HEIGHTS = {
    Basement: 3.5, Basement_Last: 3.5, Ground_Floor: 8.5, Mezzanine: 3.0, Retail: 4.5, Supermarket: 5.0,
    Podium: 3.2, Podium_Last: 3.5, Office: 3.5, Commercial: 4.0, Typical_Floor: 3.5, Hotel: 3.5,  LabourCamp: 3.5, Warehouse: 10.0, Roof: 1.0, default: 3.5
};
